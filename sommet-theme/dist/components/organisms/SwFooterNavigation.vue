<template>
  ...
  >
    <SfFooterColumn>
      <img src="http://localhost:8888/sommet-sw-back/public/media/f2/3d/a9/1614812117/logo-school.svg" height="50">
      <p class="sf-footer-logo">
        Lorem ipsum dolor sit amet, ad sit regione admodum deseruisse. Ne docendi quaestio mel, no cum aeque detraxit.
        </p>
    </SfFooterColumn>
    <SfFooterColumn
